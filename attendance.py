...
class Attendance:
    def __init__(self, root):
        ...
        #first image
        img=Image.open(r"C:\Users\harsh\OneDrive\Desktop\face_recognition system\college_images\smart-attendance.jpg")
        img=img.resize((620,200),Image.LANCZOS)
        self.photoimg=ImageTk.PhotoImage(img)

        
        f_lbl=Label(self.root,image=self.photoimg)
        f_lbl.place(x=0,y=0,width=620,height=200)


        #second image
        img1=Image.open(r"C:\Users\harsh\OneDrive\Desktop\face_recognition system\college_images\iStock-182059956_18390_t12.jpg")
        img1=img1.resize((670,200),Image.LANCZOS)
        self.photoimg1=ImageTk.PhotoImage(img1)


        f_lbl=Label(self.root,image=self.photoimg1)
        f_lbl.place(x=610,y=0,width=670,height=200)
        ...
        title_lbl=Label(bg_img,text="ATTENDANCE MANAGEMENT SYSTEM",font=("tiems new roman",28,"bold"),bg="white",fg="darkgreen")
        ...
        left_inside_frame.place(x=0,y=135,width=600,height=370) #600 y=55
        ...
        attendanceID_entry=ttk.Entry(left_inside_frame,width=16,textvariable=self.var_atten_id,font=("times new roman",13,"bold"))
        ...
        atten_roll=ttk.Entry(left_inside_frame,width=16,textvariable=self.var_atten_name,font=("times new roman",13,"bold"))
        ...
        atten_name=ttk.Entry(left_inside_frame,width=16,textvariable=self.var_atten_date,font=("times new roman",13,"bold"))
        ...
        btn_frame.place(x=0,y=300,width=715,height=35) #y=190
        ...
        delete_btn=Button(btn_frame,text="Update",width=12,font=("times new roman",13,"bold"),bg="blue",fg="white")
        ...
        Right_frame.place(x=625,y=0,width=622,height=579)


        table_frame=Frame(Right_frame,bd=2,relief=RIDGE,bg="white")
        table_frame.place(x=5,y=5,width=600,height=455) #y=190
    ...
    def importCsv(self):
        global mydata
        mydata.clear()  # Clear data each time to avoid duplicate entries
    ...
    def exportCsv(self):
        try:
            ...
            if fln:
                ...
                messagebox.showinfo("Export Cancelled", "No file selected for export", parent=self.root)
